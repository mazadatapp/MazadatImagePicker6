package com.mazadatimagepicker6.Gallery;
...
public class GalleryActivity extends AppCompatActivity {
  ...
  String title;
  private int GALLERY_REQUEST_CODE=23;
  private int PERSMISSION_REQUEST_CODE=23;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
      ...
      ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, PERSMISSION_REQUEST_CODE);
  ...
  public void copyFile(File src, File dest) throws IOException {
    ...
    try {
      ...
      finish();
      Intent intent = new Intent(this, MazadatEditPhoto.class);
